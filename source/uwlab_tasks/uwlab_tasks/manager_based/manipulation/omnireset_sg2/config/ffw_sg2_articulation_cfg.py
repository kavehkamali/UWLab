# Patched for UWLab OmniReset SG2 smoke: fixed USD path, no robotis_lab package import.
...
FFW_SG2_CFG = ArticulationCfg(
    spawn=UsdFileCfg(
        usd_path="/home/kaveh/projects/API/omnireset_ffw_stack/robotis_lab_ffw_sg2/source/robotis_lab/data/robots/FFW/FFW_SG2.usd",
